 ...
 *
 */
public class AboutHSIncidents extends BaseActivity {

	// Used to get the Log.D TAG from the strings.XML file so its flexible
	private static final String TAG = AboutHSIncidents.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.abouthsincidents);
        
        // WebView: Startup Processing ***********************************************
        WebView myWebView = (WebView) this.findViewById(R.id.AboutHSIncidentsWebView);
     ...
     // WebView: Construct HTML string to display later  ********************************
        ...
        s.append("<p><BR>  <u>HOMELAND SECURITY INCIDENTS <BR> INFO PAGE</u></p>");
        s.append("</div>");
        
        s.append("<ul>");								
        s.append("<li>This application pulls incident data from the <a href=http://earthquake.usgs.gov>US Homeland Security Incident Reports site - http://www.nationalterroralert.com</a>.</li>");
        s.append("<BR>");
        s.append("<li>Click <font color=#FF0000>GetSecurityAlerts</font> to refresh the incident list.</li>");
        s.append("<BR>");
        ...
        s.append("<ul>");								
        s.append("<li><u>WebSite</u>: - Go to the HSNIR site for this incident. </li>");
        s.append("<li><u>Details</u>: HSNIR specific summary data on the incident.</li>");
        ...
        s.append("<BR>");
        s.append("<div align=center>");
        s.append("<img src=\"file:///android_asset/info_webview_security_activity.png\" />");
        s.append("</div>");
