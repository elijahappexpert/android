 ...
 *
 */
public class AboutPollutionAlerts extends BaseActivity {

	// Used to get the Log.D TAG from the strings.XML file so its flexible
	private static final String TAG = AboutPollutionAlerts.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aboutpollution);
        
        // WebView: Startup Processing ***********************************************
        WebView myWebView = (WebView) this.findViewById(R.id.AboutPollutionAlertsWebView);
     ...
     // WebView: Construct HTML string to display later  ********************************
        ...
        s.append("<p><BR> <u>POLLUTION ALERTS INFO PAGE</u></p>");
        s.append("</div>");
        
        s.append("<ul>");								
        s.append("<li>This application pulls realtime alerts data from the <a href=http://alerts.skytruth.org>Skytruth Environmental Incident Alert System - http://alerts.skytruth.org</a>.</li>");
        s.append("<BR>");
        s.append("<li>Click <font color=#FF0000>GetPollutionAlerts</font> to refresh the alert list.</li>");
        s.append("<BR>");
        ...
        s.append("<ul>");								
        s.append("<li><u>WebSite</u>: - Go to the Skytruth Alerts site for this alert. </li>");
        s.append("<li><u>Map</u>: Use Google Maps to locate this alert.</li>");
        s.append("<li><u>Quick View</u>: Quick picture / Info on the alert.</li>");
        s.append("<li><u>Details</u>: Skytruth Alerts summary data on the alert.</li>");
        ...
        s.append("<BR>");
        s.append("<div align=center>");
        s.append("<img src=\"file:///android_asset/info_webview_pollution_activity.png\" />");
        s.append("</div>");
