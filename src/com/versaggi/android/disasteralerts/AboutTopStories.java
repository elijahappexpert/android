 ...
 *
 */
public class AboutTopStories extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.abouttopstories);
        
        // WebView: Startup Processing ***********************************************
        WebView myWebView = (WebView) this.findViewById(R.id.AboutTopStoriesWebView);
     ...
     // WebView: Construct HTML string to display later  ********************************
        ...
        s.append("<p><u>TOP STORIES INFO PAGE</u></p>");
        s.append("</div>");
        
        s.append("<ul>");								
        s.append("<li><u>DATA SOURCE</u>: This application pulls realtime incident data from the <a href=http://hisz.rsoe.hu> RSOE EDIS - Emergency and Disaster Information System - http://hisz.rsoe.hu</a>. <BR> </li>");
        s.append("<BR>");
        s.append("<li>Click <font color=#FF0000>GetTopStories</font> to refresh the incident list.</li>");
        s.append("<BR>");
        ...
        s.append("<ul>");								
        s.append("<li><u>WebSite</u>: - Go to the RSOE EDIS web site for this incident. </li>");
        s.append("<li><u>Map</u>: Use Google Maps to locate the incident.</li>");
        s.append("<li><u>Quick View</u>: Quick picture / Info on the incident.</li>");
        s.append("<li><u>Details</u>: RSOE EDIS specific summary of the incident.</li>");
        s.append("<li><u>Google It</u>: Do a google search on this incident.</li>");
        s.append("<li><u>Share</u>: Send friends this incident story.</li>");
        s.append("</ul>");	       
        
        
        s.append("<BR>");
        s.append("<div align=center>");
        s.append("<img src=\"file:///android_asset/info_webview_topstories_activity.png\" />");
        s.append("</div>");
